...
## 📌 Sobre o Repositório
Neste repositório, disponibilizarei meus exercícios de lógica de programação. O objetivo é registrar minha evolução e o aprendizado de novas sintaxes ao longo do tempo, começando pelos fundamentos e avançando para linguagens reais conforme o progresso nos estudos.
